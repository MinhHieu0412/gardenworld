...
function Gardentip() {
  ...
  return (
    <>
      ...
      <Row className='content2 animation'>
      <Col className='video2 '>
        <video src={video1} controls className='video'></video>
        <p>14 Clever Plant Hacks That Will Really Grow on You! </p>
        </Col>
        <Col className='video2'>
        <video src={video2} controls className='video'></video>
        <p>Top 6 Common Indoor Plants That Can Grow In Water</p>
        </Col>
        <Col className='video2'>
        <video src={video3} controls className='video'></video>
